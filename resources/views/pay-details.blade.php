...
<div class="content" style="margin-top: 80px; padding-top: 20px;">
    <div class="container">
        <div class="row justify-content-center" style="padding-top:50px "> <!-- Center the content -->
            <div class="col-md-12">
                <!-- page content -->
                <div class="x_panel">
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <section class="content invoice">
                                            ...
                                            <div class="  invoice-header">
                                                <h1>
                                                    <img src="{{asset('assets/images/logo_black.png')}}" alt="Image" class="img-fluid" />
                                            ...
                                            <div class="col-sm-4 invoice-col">
                                                From
                                                <address>
                                                                <strong>Dvisional Secretariat Office</strong>
                                                                <br>Nuwaraeliya Rd,
                                                                <br> Sri Lanka,Gampola, 20500
                                                                <br>Phone: +94 812 352236
                                                                <br>Email: info@udapalatha.ds.gov.lk
                                                </address>
